...
#define SDA(n) {n?GPIO_WriteBit(GPIOB,GPIO_Pin_7,1):GPIO_WriteBit(GPIOB,GPIO_Pin_7,0);}

#define CLK(n) {n?GPIO_WriteBit(GPIOB,GPIO_Pin_6,1):GPIO_WriteBit(GPIOB,GPIO_Pin_6,0);}
